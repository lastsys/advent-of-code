package com.lastsys.aoc.aoc2018.Day01
...
class Day01Spec extends FlatSpec with Matchers {
  "Part 1" should "pass test case 1" in {
    val data = readData("2018/day01/test-input-p1-01.txt")
    data.map(part1) shouldBe Success(3)
  }

  it should "pass test case 2" in {
    val data = readData("2018/day01/test-input-p1-02.txt")
    data.map(part1) shouldBe Success(3)
  }

  it should "pass test case 3" in {
    val data = readData("2018/day01/test-input-p1-03.txt")
    data.map(part1) shouldBe Success(0)
  }

  it should "pass test case 4" in {
    val data = readData("2018/day01/test-input-p1-04.txt")
